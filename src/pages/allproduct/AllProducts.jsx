              ...
              .map((item, index) => {
                ...
                return (
                  <div
                    ...
                    key={index}
                    className="p-4 md:w-1/4 drop-shadow-lg product-card"
                  >
                    <div
                      ...
                      <div className="flex flex-col flex-grow p-5 border-t-2">
                        ...
                        <div className="flex justify-center mt-auto">
                          <button
                            ...
                            className="focus:outline-none text-white bg-black hover:bg-orange-700 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm w-full py-2"
                          >
                            Add To Cart
                          </button>
                        </div>
